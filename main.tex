...
\title{Using Git and GitHub for Open Science Workshop}
...
\begin{abstract}
This is an example paper with \LaTeX and hosted at OverLeaf (MPIDR's ShareLatex) with a backup saved on GitHub.
\end{abstract}
...
It did not work! As Git would not allow you to pull changes from multiple remotes, the solution is to make changes on OverLeaf (or local computer) and push to both remotes (GitHub as backup).
